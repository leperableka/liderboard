      ...
      try {
        ...
        if (bot && miniAppUrl) {
          const welcomeText =
            ...
            'Чтобы не потерять доступ к турниру и быстро находить бота в Telegram, закрепите этот чат у себя в списке диалогов 📌 Либо создайте отдельную папку (например, «Турнир») и добавьте чат туда.\n\n' +
            '1) Закрепить чат в Telegram\n' +
            '• Нажмите и удерживайте этот чат (или сделайте свайп влево на iPhone).\n' +
            '• Выберите «Закрепить» 📌\n\n' +
            '2) Добавить чат в папку\n' +
            '• Откройте Настройки Telegram → Папки (Папки чатов)\n' +
            '• Нажмите «Создать новую папку»\n' +
            '• Добавьте туда этот чат с ботом ✅\n\n' +
            '3) Добавить приложение турнира на экран телефона\n' +
            'Так же вы можете разместить приложение торгового турнира как ярлык на экран телефона — чтобы открывать его как обычное приложение.\n' +
            'Как сделать:\n' +
            '• Откройте приложение торгового турнира.\n' +
            '• В правом верхнем углу нажмите на три точки (⋯).\n' +
            '• Выберите «Добавить на экран» / «Add to Home Screen».\n' +
            '• Дальше следуйте подсказкам — шаги могут немного отличаться в зависимости от версии Android или iOS. ✅';
